...
var Gulpfile = Gulpfile_1 = (function () {
    ...
    Gulpfile.forConfig = function (config) {
        ...
        if (config) {
            Object.keys(config).forEach(function (key) { return exports.DEFAULT_CONFIG[key] = config[key]; });
        }
        return Gulpfile_1;
    };
    ;
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, pm2.connect(function () {
                        pm2.start({
                            ...
                            watch: (_this.isDevMode()) ? _this.src : undefined,
                            ignore_watch: (_this.isDevMode()) ? ["node_modules"].concat(_this.tsSrc) : undefined,
