...
var Gulpfile = (function () {
    function Gulpfile() {
        ...
        this.webConcurrency = process.env.WEB_CONCURRENCY || -1; // Set by Heroku or -1 to scale to max cpu core -1
        this.maxMemory = process.env.WEB_MEMORY || 512; // " " "
    }
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, pm2.connect(function () {
                        pm2.start({
                            ...
                            name: 'production-app',
                            exec_mode: 'cluster',
                            instances: _this.webConcurrency,
                            max_memory_restart: _this.maxMemory + 'M',
                            env: {
                                "NODE_ENV": _this.environment,
                            },
