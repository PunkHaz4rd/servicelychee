...
var Gulpfile = Gulpfile_1 = (function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, pm2.connect(function () {
                        pm2.start({
                            ...
                            interpreterArgs: ["--insepct=" + _this.config.port.debug],
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.typescript().then(function () {
                        gulp.src(_this.config.paths.integrationTests, { read: false })
                            .pipe(mocha({
                            reporter: 'spec',
                        }));
                    })];
    ...
    Gulpfile.prototype.unitTest = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.typescript().then(function () {
                        gulp.src(_this.config.paths.unitTests, { read: false })
                            .pipe(mocha({
                            reporter: 'spec',
                        }));
                    })];
