...
var Gulpfile = Gulpfile_1 = (function () {
    function Gulpfile() {
        ...
        // PATHS
        this.src = this.config.paths.typescript.concat(this.config.paths.resources);
        this.ignoreRunningSrc = ["node_modules"].concat(this.config.paths.typescript);
        this.runningSrc = this.config.paths.generated.concat(this.config.paths.resources);
        // PRE-CONFIG
        this.tsProject = ts.createProject(this.config.paths.tsConfig);
    }
    /**
    ...
    Gulpfile.forConfig = function (config) {
        ...
        if (config) {
            Object.keys(config).forEach(function (key) { return exports.DEFAULT_CONFIG[key] = _.merge(config[key], exports.DEFAULT_CONFIG[key]); });
        }
        return Gulpfile_1;
    };
    ;
    ...
    Gulpfile.prototype.watch = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, watch(this.config.paths.typescript, function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
    ...
    Gulpfile.prototype.server = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                PRIVATE_KEY = "XXXXX";
                PUBLIC_KEY = "XXXXX";
                return [2 /*return*/, pm2.connect(function () {
                        pm2.start({
                            script: ".",
                            name: _this.config.name,
                            exec_mode: (_this.isDevMode()) ? "fork" : "cluster",
                            instances: (_this.isDevMode()) ? 1 : _this.config.webConcurrency,
                            max_memory_restart: _this.config.maxMemory + "M",
                            source_map_support: true,
                            env: {
                                "NODE_ENV": _this.config.environment,
                                "PORT": _this.config.port.web,
                            },
                            interpreterArgs: ["--debug=" + _this.config.port.debug],
    ...
    Gulpfile.prototype.integrationTest = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, gulp.src(this.config.paths.integrationTests, { read: false })
                        .pipe(mocha({
                        reporter: 'spec',
                    }))];
            });
    ...
    Gulpfile.prototype.unitTest = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, gulp.src(this.config.paths.unitTests, { read: false })
                        .pipe(mocha({
                        reporter: 'spec',
                    }))];
            });
    ...
    Gulpfile.prototype.test = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.unitTest().then(this.integrationTest.bind(this))];
            });
        });
    };
