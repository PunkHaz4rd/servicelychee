...
var DocumentFacade = (function (_super) {
    ...
    function DocumentFacade(DbModel, act, args) {
    ...
    DocumentFacade.prototype._sync = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this._hasSync() && model._sync == null)) return [3 /*break*/, 3];
    ...
    DocumentFacade.prototype._hasSync = function () {
    ...
    DocumentFacade.prototype.prepareInputForWriting = function (input) {
