...
var RestFacade = (function (_super) {
    __extends(RestFacade, _super);
    function RestFacade(Schema, act, args) {
        var _this = _super.call(this, act, args) || this;
        _this.Schema = Schema;
        return _this;
    }
    RestFacade.prototype._callSync = function (id, data) {
        if (data === void 0) { data = {}; }
    ...
    RestFacade.prototype._sync = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            var error, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!model._kiwiId) return [3 /*break*/, 3];
    ...
    RestFacade.prototype._doSync = function (update) {
        return !this.args.noSync || Object.keys(update)
            .filter(function (key) { return !key.startsWith('_'); })
            .length > 0;
    };
    RestFacade.prototype._name = function () {
        return this.args.role;
    };
    RestFacade.prototype.create = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RestFacade.prototype.update = function (conditions, update) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var models;
            return __generator(this, function (_a) {
    ...
    RestFacade.prototype.updateOne = function (conditions, update) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RestFacade.prototype.updateById = function (id, update) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RestFacade.prototype.find = function (query) {
    ...
    RestFacade.prototype.findOne = function (query) {
        if (query === void 0) { query = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                query._deactivated = null;
    ...
    RestFacade.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.Schema
                        .findById(id)
    ...
    RestFacade.prototype.remove = function (conditions) {
    ...
    RestFacade.prototype.removeOne = function (conditions) {
        if (conditions === void 0) { conditions = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    RestFacade.prototype.removeById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    RestFacade.prototype.clean = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
